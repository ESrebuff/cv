        ...
        <div className="cv">
          ...
          <Section title="Éducation">
            <ul>
              ...
              <li>
                Concepteur Développeur d'Application Java Fullstack, Diginamic,
                2021 - 2022
              </li>
          ...
          <Section title="Expérience Professionnelle">
            <div>
              ...
              <ul>
                <li>
                  Automatisation de l’envoi d’emails et gestion de documents via
                  Google Sheets et AppScript.
                </li>
                <li>
                  Développement de pages web en Vue + Nuxt et React + Next,
                  intégration de maquettes, création de formulaires et éléments
                  visuels.
                </li>
                <li>
          ...
          <Section title="Compétences Techniques">
            <p>
              HTML, CSS, SCSS, JavaScript, TypeScript, Node.js, Java, PHP, SQL,
              Express, Spring, Angular, Vue.js, Nuxt.js, React, Next.js, Google
              AppScript, Cypress, MUI, Tailwind CSS, SCRUM, CI/CD
            </p>
          </Section>
