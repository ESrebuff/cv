    ...
    <div>
      ...
      <div className={`drawer-fixed ${isMenuVisible ? "visible" : "hidden"}`}>
        <div className="container-avatar">
          <img
            className="avatar"
            src="https://media.licdn.com/dms/image/D4E03AQF1VYfU6KgzwA/profile-displayphoto-shrink_800_800/0/1710792552469?e=1719446400&v=beta&t=gVa9zxgPKQmMnkZxfM4uh5SCHfCwsyDDaXPbRmgLsmQ"
        ...
        {/* je veux avoir un bloc rouge en bas à la place de ce commentaire */}
        <div className="test">
          test
          <a href="https://github.com/ESrebuff">
          ...
          <a href="https://www.linkedin.com/in/esteban-rebuff%C3%A9-mareau-aab8bb20a/">
